...
function formHtml(m, options, isAdminEditing) {
  ...
  return `
    <form id="profile-form">
      <div class="msg" id="profile-msg-top"></div>
      ...
      <fieldset>
        ...
        <div class="form-grid">
          ...
          <div class="full">
            ...
            <p class="field-hint">No añadas palabras como "Grado", "Curso", etc., solo el nombre de la titulación, con la primera letra en mayúscula (p. ej. "Magisterio", no "magisterio").</p>
...
function showMsg(text, isError) {
  ['profile-msg-top', 'profile-msg'].forEach((id) => {
